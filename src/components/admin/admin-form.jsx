    ...
    <div className="admin-form content">
      ...
      <div className="consoles">
        <div className="console">
          <div className="form-type" onClick={() => showForm(1)} aria-hidden="true">
            Add player
          </div>
        ...
        <div className="console">
          <div className="form-type" onClick={() => showForm(2)} aria-hidden="true">
        ...
        <div className="console">
          <div className="form-type" onClick={() => showForm(3)} aria-hidden="true">
            Match result
          </div>
        ...
        <div className="console">
          <div className="form-type" onClick={() => showForm(4)} aria-hidden="true">
            Upload video
          </div>
          {index === 4 && <VideoUpload />}
        </div>
